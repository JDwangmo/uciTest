...
logging.basicConfig(filename='sms_20160520.log', filemode='w', format='%(asctime)s : %(levelname)s : %(message)s',
                    level=logging.DEBUG)
...
data_file_path = '/home/jdwang/PycharmProjects/uciTest/dataset/farm-data/farm-ads'
